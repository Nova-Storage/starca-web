import alabama from './alabma.json'
...
import deleware from './deleware.json'
import district_of_columbia from './district_of_columdistrict_of_columbiabia.json'
...
import new_hampshire from './new_hampshire.json'
import new_jersey from './new_jersey.json'
import new_mexico from './new_mexico.json'
import new_york from './new_york.json'
import north_carolina from './north_carolina.json'
import north_dakota from './north_dakota.json'
import ohio from './ohio.json'
import oklahoma from './oklahoma.json'
import oregon from './oregon.json'
import penssylvania from './penssylvania.json'
import rhode_island from './rhode_island.json'
import south_carolina from './south_carolina.json'
import south_dakota from './south_dakota.json'
...
import west_virginia from './west_virginia.json'
...
let items3 = [montana, nebraska, nevada, new_hampshire,
    new_jersey, new_mexico, new_york, north_carolina, north_dakota, 
    ohio, oklahoma, oregon]

// let items4 = [
//     penssylvania, rhode_island, south_carolina, 
